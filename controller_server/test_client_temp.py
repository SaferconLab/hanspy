...
def test_simple_gripper(client, gripper_test_name):
    ...
    # 设置夹爪幅度为50%
    print("设置夹爪幅度为50%...")
    response = send_command(client, "set_gripper_amplitude", {"amplitude": 50}, f"set_amp_50_{gripper_test_name}")
    ...
    # 获取当前夹爪位置
    print("获取当前夹爪位置...")
    response = send_command(client, "get_gripper_position", {}, f"get_pos_50_{gripper_test_name}")
    if response and response.get("status") == "success":
    ...
    # 设置夹爪幅度为100%
    print("设置夹爪幅度为100%...")
    response = send_command(client, "set_gripper_amplitude", {"amplitude": 100}, f"set_amp_100_{gripper_test_name}")
    if response and response.get("status") == "success":
        print("✓ 夹爪幅度设置为100%成功")
    else:
        print("✗ 夹爪幅度设置为100%失败")
    ...
    # 获取当前夹爪位置
    print("获取当前夹爪位置...")
    response = send_command(client, "get_gripper_position", {}, f"get_pos_100_{gripper_test_name}")
    if response and response.get("status") == "success":
        position = response.get("data", {}).get("position", -1)
        print(f"✓ 当前夹爪位置: {position}%")
    else:
    ...
    # 设置夹爪幅度为0%
    print("设置夹爪幅度为0%...")
    response = send_command(client, "set_gripper_amplitude", {"amplitude": 0}, f"set_amp_0_{gripper_test_name}")
    if response and response.get("status") == "success":
        print("✓ 夹爪幅度设置为0%成功")
    else:
        print("✗ 夹爪幅度设置为0%失败")
    ...
    # 获取当前夹爪位置
    print("获取当前夹爪位置...")
    response = send_command(client, "get_gripper_position", {}, f"get_pos_0_{gripper_test_name}")
    if response and response.get("status") == "success":
        position = response.get("data", {}).get("position", -1)
        print(f"✓ 当前夹爪位置: {position}%")
    else:
    ...
    try:
        ...
        try:
            ...
            if response and response.get("status") == "success":
                ...
                # 夹爪测试 - 交叉测试
                print("\n[6.5] 交叉测试 - 夹爪测试 (正向运动后)...")
                test_simple_gripper(client, "gripper_6.5")
                ...
                # 夹爪测试 - 交叉测试
                print("\n[6.7] 交叉测试 - 夹爪测试 (反向运动后)...")
                test_simple_gripper(client, "gripper_6.7")
        ...
        try:
            ...
            if response and response.get("status") == "success":
                ...
                test_simple_gripper(client, "gripper_7.5")
                ...
                test_simple_gripper(client, "gripper_7.7")
        ...
        try:
            ...
            if response and response.get("status") == "success":
                ...
                test_simple_gripper(client, "gripper_8.5")
        ...
        try:
            ...
            if response and response.get("status") == "success":
                ...
                test_simple_gripper(client, "gripper_9.5")
